...
void ShowColumn(string TableName);
void UseDatabase(string DbName);
void CreateTable(string filename,vector<string> colname,vector<string> coltype);
void DropDatabase(string DbName)  ;
void DropTable(string fileName);
void DropDbTable(string DbName,string TableName) ;
void Select0(string TableName);
void Select1(string Selection, string TableName, string Condition ,string Operator );
